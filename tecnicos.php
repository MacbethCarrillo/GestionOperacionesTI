...
<script>
    ...
    // Abrir el modal de Catálogo al hacer clic en el botón
    openModalCatalogo.onclick = () => modalCatalogo.style.display = "block";

    // Cerrar el modal de Catálogo al hacer clic en la 'X'
    closeModalCatalogo.onclick = () => modalCatalogo.style.display = "none";

    // Cerrar el modal de Catálogo si se hace clic fuera del contenido
